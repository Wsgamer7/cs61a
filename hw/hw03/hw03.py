...
def totals_tree(m):
    ...
    if is_planet(m):
        ...
        branch_m = [totals_tree(end(left(m ))),totals_tree(end(right(m)))]
        return tree(total_weight(m),branch_m)
...
def replace_leaf(t, find_value, replace_value):
    ...
    if  is_leaf(t):
        ...
        branch_t = [replace_leaf(s,find_value ,replace_value ) for s in branches(t)]
        return tree(label(t), branch_t)
...
def has_path(t, word):
    ...
    if is_leaf(t) or len(word) == 1:
        ...
        if label(t) != word[0]:
            ...
            inti = False
            for s in branches(t):
                inti = inti or has_path(s,word[1: ])
                if inti:
                    return True
            return inti
