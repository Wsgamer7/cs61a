...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        place = self.place
        while place != beehive:
            if self.min_range <= count_foot<= self.max_range:
                if place.bees !=[ ]:
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        for bee in self.place.bees[:]:
            bee.reduce_armor(amount + death_mul * self.damage)
...
# END Problem EC
    ...
    def __init__(self, armor=1):
        ...
        self.exist_number = QueenAnt.exist_number
        QueenAnt.exist_number += 1
        # END Problem EC
    ...
    def remove_from(self, place):
        if (isinstance(self, QueenAnt) and self.exist_number>0) or not isinstance(self, QueenAnt):
